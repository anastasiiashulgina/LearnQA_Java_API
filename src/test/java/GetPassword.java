...
public class GetPassword {
    ...
    public void GetPasswordTest() {
        ...
        ArrayList<String> listOfPasswords = new ArrayList<>(Arrays.asList("password", "password", "123456", "123456", "123456", "123456", "123456", "123456", "123456",
        ...
        for (int i = 0; i < listOfPasswords.size(); i++) {
            ...
            params.put("password", listOfPasswords.get(i));

            Response responseForGettingPassword = RestAssured
                    .given()
                    .body(params)
                    .when()
            ...
            cookies.put("auth_cookie", responseForGettingPassword.cookie("auth_cookie"));

            Response responseToCheckAuthCookie = RestAssured
                    .given()
                    .body(params)
                    .cookies(cookies)
                    .when()
            ...
            if (!responseToCheckAuthCookie.htmlPath().getString("html.body").equals("You are NOT authorized"))
            {System.out.println(responseToCheckAuthCookie.htmlPath().getString("html.body"));
                System.out.println("Correct password: " + listOfPasswords.get(i));
                break;
           }
